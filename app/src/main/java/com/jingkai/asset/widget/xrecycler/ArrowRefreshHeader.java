package com.jingkai.asset.widget.xrecycler;
...
import com.jingkai.asset.widget.xrecycler.progressindicator.AVLoadingIndicatorView;
...
public class ArrowRefreshHeader extends LinearLayout implements BaseRefreshHeader {
	...
	private void initView() {
        ...
        lastRefreshTime=format.format(new Date());
        mHeaderTimeView.setText(lastRefreshTime);
	}
