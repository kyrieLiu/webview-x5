package com.jingkai.asset.widget.view;
...
public class LoadExceptionView extends RelativeLayout {
    ...
    public LoadExceptionView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public LoadExceptionView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
