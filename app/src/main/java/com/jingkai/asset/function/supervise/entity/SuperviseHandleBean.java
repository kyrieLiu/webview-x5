...
public class SuperviseHandleBean {
    private List<SuperviseHandleBean.ItemsBean> items;
    private int total;

    public List<SuperviseHandleBean.ItemsBean> getItems() {
        return items;
    }

    public void setItems(List<SuperviseHandleBean.ItemsBean> items) {
        this.items = items;
    }
